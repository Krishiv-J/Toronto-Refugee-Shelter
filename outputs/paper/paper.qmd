---
title: "Evaluating the Need and Impact of Recent Policies and Increased Funding on Refugees in Toronto's Homeless Shelters"
author: 
  - Krishiv Jain
...
final_refugees_data |>
  ...
  scale_x_date(date_labels = "%b %Y", date_breaks = "1 year")
```
## Total number of refugees in the system and Refugees Percentage of Population Combined 
```{r}
#| echo: false
#| include: true
#| message: false
